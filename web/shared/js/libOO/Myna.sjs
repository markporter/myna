...
/* Function: captureContent   
	...
	Parameters: 
		...
		scope		-	*Optional, default true*
						The scope in which to execute _func_
								
	Returns: 
		content generated by _func_
...
/* Function: includeContent   
	...
	Parameters: 
		...
		scope 			-	*Optional, default <$server.globalScope>* This is the 
								object that will be passed as the "this" object to the 
								script
		cacheOptions	-	*Optional, default null*
								If this is defined, then these options will be passed to 
								a <Myna.Cache> instance for the results of this include 
